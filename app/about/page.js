...
export default function page() {
  return (
    <div className="md:min-w-[40%] md:max-w-[100%] md:p-3 p-2 md:rounded-md mx-auto mt-4 shadow-2xl bg-slate-900 flex flex-col about-opacity ">
      ...
      <Storytelling>
        Bien que j’ai suivi des formations académiques en informatique, c’est
      ...
      <p className="text-[0.8rem] mt-2"> Je suis toujours à la recherche de nouveaux défis et de collaborations enrichissantes. Si vous voulez en savoir plus, n’hésitez pas <Link href="/contact" className="text-[#3c93b9] font-bold" >à me contacter ! </Link> </p>
